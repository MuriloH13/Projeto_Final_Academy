...
import 'package:projeto_final_academy/core/routes/app_Routes.dart';
          ...
          return Scaffold(
            ...
            body: Column(
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.popAndPushNamed(context, AppRoutes.homeScreen).then((_) {
                      context.read<TripState>().load();
                    });
                  },
                  child: Text(
